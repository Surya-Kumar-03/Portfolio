...
function Skills() {
  ...
  return (
    <div className="flex flex-col flex-grow justify-center items-center z-[-1] m-4 overflow-hidden">
      <h1 className="text-styling text-5xl m-4 animateSkillsHeading">Skills: </h1>
      <h1 className="-mt-10 mb-2">____</h1>
      <h1 className="text-3xl text-center animateFont-after">My Websites are usually a bundle of..</h1>
