...
function Skills() {
  return (
    ...
    >
      ...
      <h1 className="text-2xl lg:text-3xl text-center animateFont-after">
        My{" "}
        <span className="cardsSubtitleFont text-4xl lg:text-5xl m-1 text-pink-600 italic">
          apps
        </span>{" "}
      ...
      <div className="flex flex-col w-full bg-teal-50 my-2 rounded-xl p-3 shadow-md">
        ...
        <div className="flex flex-col w-full mt-2 mr-2 bg-red-100 rounded-xl p-2">
          <h1 className="text-2xl lg:text-3xl text-center animateFont-after">
            <span className="cardsSubtitleFont text-3xl lg:text-5xl m-1 text-pink-600 italic">
              Cloud platforms 
            </span>{" "}
            I am familiar with..
          </h1>
