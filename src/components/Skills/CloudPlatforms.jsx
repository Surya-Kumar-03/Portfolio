...
function CloudPlatforms() {
  return (
    <div className="flex flex-row h-auto w-auto justify-center items-center">
      <Icon icon="logos:google-cloud" width="55" height="55" className="sm:hover:scale-110 transition-all"/>
      <Icon
      ...
      />
      <Icon icon="vscode-icons:file-type-netlify" width="55" height="55" className="sm:hover:scale-110 transition-all"/>
    </div>
  );
}
